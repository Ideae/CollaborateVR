...
namespace UnityEngine.EventSystems
{
    public class OVRInputModule : PointerInputModule
    {
        ...
        public String joyPadClickButton = "Fire1";
...
#region PointerEventData pool
        ...
        {
            var pressed = Input.GetKeyDown(gazeClickKey) || Input.GetButtonDown(joyPadClickButton);
            var released = Input.GetKeyUp(gazeClickKey) || Input.GetButtonUp(joyPadClickButton);
        ...
        protected Vector2 GetExtraScrollDelta()
        {
            ...
            {
              float rStickHoriz = Input.GetAxis("RightHorizontal");
              float rlStickVert = Input.GetAxis("RightVertical");
              Vector2 s = new Vector2(rStickHoriz,rlStickVert);
